...
class Ui_deletePojectDailog(object):
    ...
    def retranslateUi(self, deletePojectDailog):
        ...
        deletePojectDailog.setWindowTitle(_translate("deletePojectDailog", "Dialog"))
        self.yes_button.setText(_translate("deletePojectDailog", "Yes"))
        self.no_button.setText(_translate("deletePojectDailog", "No"))
