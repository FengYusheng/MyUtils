...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.numberLineEdit = QtWidgets.QLineEdit(self.dockWidgetContents_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.numberLineEdit.setText(_translate("MainWindow", "001"))
        self.numberLineEdit.setPlaceholderText(_translate("MainWindow", "Type number here."))
