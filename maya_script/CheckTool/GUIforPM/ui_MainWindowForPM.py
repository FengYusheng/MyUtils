...
#
# Created: Tue Oct 31 14:29:02 2017
...
class Ui_MainWindowForPM(object):
    ...
    def retranslateUi(self, MainWindowForPM):
        MainWindowForPM.setWindowTitle(QtWidgets.QApplication.translate("MainWindowForPM", "PM_View", None, -1))
        ...
        self.project_combo.setItemText(0, QtWidgets.QApplication.translate("MainWindowForPM", "New project", None, -1))
