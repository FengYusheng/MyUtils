...
class Ui_MWBevelToolMainWindow(object):
    def setupUi(self, MWBevelToolMainWindow):
        ...
        self.controlDock.setMinimumSize(QtCore.QSize(280, 560))
        ...
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.bevelSetGroupBox)
        ...
        self.verticalLayout_4.addWidget(self.newBevelSetButton)
        ...
        self.verticalLayout_4.addWidget(self.memberButton)
        ...
        self.verticalLayout_4.addWidget(self.bevelButton)
        self.line = QtWidgets.QFrame(self.bevelSetGroupBox)
        ...
        self.verticalLayout_4.addWidget(self.addMemberButton)
        ...
        self.verticalLayout_4.addWidget(self.removeMemberButton)
        ...
        self.verticalLayout_4.addWidget(self.deleteBevelSetbutton)
        ...
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.bevelGroupBox)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.finishBevelButton = QtWidgets.QPushButton(self.bevelGroupBox)
        self.finishBevelButton.setObjectName("finishBevelButton")
        self.verticalLayout_3.addWidget(self.finishBevelButton)
        self.verticalLayout_2.addWidget(self.bevelGroupBox)
        ...
        self.verticalLayout_2.addWidget(self.selectionGroupBox)
        ...
        self.editMenu.addAction(self.finishBevelAction)
    ...
    def retranslateUi(self, MWBevelToolMainWindow):
        ...
        self.bevelButton.setText(QtWidgets.QApplication.translate("MWBevelToolMainWindow", "Back to bevel ", None, -1))
        ...
        self.finishBevelButton.setText(QtWidgets.QApplication.translate("MWBevelToolMainWindow", "Finish bevel", None, -1))
